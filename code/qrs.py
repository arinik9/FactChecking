...
#####################
	...
	def displaySr(self, results, w, pos_annotations=None, legend_horizontal_margin=150, legend_location="upper left"):
		"""
                ...
                if pos_annotations != None:
                    ...
                    for pos in pos_annotations:
                            ...
                            if i>len(x) or j>len(x):
                                    return "Annotation error (Out of index). Check your annotation list!"
	...
	def displaySp(self, results, w, pos_annotations=None, legend_horizontal_margin=150, legend_location="upper left"):
		"""
